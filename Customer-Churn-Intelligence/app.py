...
# ==========================================
# 3. AUTHENTIC APPLE LIGHT THEME (FULL CSS OVERRIDE)
# ==========================================
apple_design_css = """
<style>
@import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');

/* Force entire canvas to Apple Off-White */
...
/* Apple Header & Subtitle Typography */
.hero-title {
...
/* Apple White Glass Cards for Form Columns */
...
/* Force Input Fields (Selectbox, Number, Text) to Apple Light Style */
...
/* Field Labels & Hinglish Helper Subtext */
label, label p {
    color: #1D1D1F !important;
...
.result-card.low { background: #F2FAF1; border-color: #34C759; }
.result-card.medium { background: #FFF9E6; border-color: #FFCC00; }
.result-card.high { background: #FDECEB; border-color: #FF3B30; }

.result-title { font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.08em; color: #86868B; font-weight: 600; }
.result-value { font-size: 3.2rem; font-weight: 700; color: #1D1D1F; line-height: 1; margin-top: 6px; }
.status-badge { font-size: 1.05rem; font-weight: 600; padding: 10px 22px; border-radius: 980px; }
...
if st.button("Analyze Risk Profile"):
    ...
    <div class="result-card {risk_class}">
        <div>
            ...
            <div style="color: #86868B; margin-top: 8px; font-size: 0.95rem; font-weight: 500;">{advice}</div>
        </div>
        <div>
